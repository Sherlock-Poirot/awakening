package com.detective.stone.oauth2server.service;

import com.detective.stone.oauth2server.entity.User;
...
public class UserService implements UserDetailsService {
    ...
    public void initData() {
        ...
        userList.add(new User("macro", password,
            AuthorityUtils.commaSeparatedStringToAuthorityList("admin")));
        userList.add(new User("andy", password,
